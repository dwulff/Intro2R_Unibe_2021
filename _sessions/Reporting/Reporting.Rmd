...
<ul>
  <li class="m1"><span>RMarkdown allows the creation of different <high>document types</high>.</span></li><br>
  <ul>
    <li><span><high>Text documents</high></span></li>
    <li><span>Presentations</span></li>   
    <li><span>Dashboards (Cockpits)</span></li>
    <li><span>Books</span></li>
    <li><span>Web-Pages</span></li>
...
<ul>
  ...
  <ul>
    <li><span>Text documents</span></li>
    <li><span><high>Presentations</high></span></li>   
    <li><span>Dashboards (Cockpits)</span></li>
    <li><span>Books</span></li>
    <li><span>Web-Pages</span></li>
  </ul>
...
<br><br>
<iframe src="https://dwulff.github.io/Intro2R_Unibe_2021/_sessions/Reporting/Reporting.html" width="800" height="500"></iframe>
...
<ul>
  ...
  <li class="m2"><span>Paths in RMarkdown have to be <high>relativ to the .Rmd</high> file.</span></li>
</ul>
...
# Read CSS (more about that later)
